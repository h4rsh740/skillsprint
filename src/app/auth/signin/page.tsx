            ...
            <div className="login-container">
              ...
              <div className="email-login">
                ...
                <div className="login-h-container">
                  ...
                  <p>Don’t have an account? <Link href="/auth/signup">Sign up Free!</Link></p>
                </div>
                ...
                <form onSubmit={handleEmailLogin} className="auth-form">
                  ...
                  <button type="submit" disabled={loading || opLoading !== null || !email || !password}>
                    {opLoading === "email" ? <Loader2 className="w-6 h-6 animate-spin mx-auto" /> : "Login with Email"}
                  </button>
                </form>
              </div>
            </div>
