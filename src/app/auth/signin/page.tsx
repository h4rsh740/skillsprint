...
function SignInContent() {
  ...
  // Handle URL errors (e.g. from LinkedIn OAuth failure)
  useEffect(() => {
    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-[#090D16] font-sans text-white selection:bg-[#4f46e5] selection:text-white p-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[440px] animate-in fade-in slide-in-from-bottom-6 duration-700">
        ...
        <div className="liquid-glass bg-[#0e1726]/40 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 shadow-2xl shadow-black/40">
          ...
          <p className="text-[13px] text-gray-400 text-center mb-8">Select an account provider to sign in</p>
          ...
          <p className="text-center text-[12px] text-gray-500 mt-8 leading-relaxed">
            By continuing, you agree to SkillSprint AI&apos;s <br />
            <span className="text-gray-400 font-medium hover:underline cursor-pointer">Terms of Service</span> and <span className="text-gray-400 font-medium hover:underline cursor-pointer">Privacy Policy</span>.
          </p>
        </div>
      </div>
    </div>
